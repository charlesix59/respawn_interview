...
> 📕：至于为什么会出现这个问题，需要先和大家聊一点数学问题。
> 
> 对于二进制，1.1 转化为十进制是什么？给你三秒思考时间！
> 
> 3，2，1！ 答案是：1.5
> 
> 这个结果的计算方式是 1*2^0 + 1 * 2 ^ (-1) 即 1 + 1/2 = 1.5
> 
> 所以对于0.1， 用二进制表示会导致其成为一个无线不循环小数。因为js使用的64位浮点数，所以只能采用一个近似值代替
> 
> 这个近似值是：0.00011001100110011001100110011001100110011001100110011010
> 
> 对于 0.2 这个近似值是：0.0011001100110011001100110011001100110011001100110011010
> 
> 二者相加为：0.0100110011001100110011001100110011001100110011001100111
> 
...
- 在应用于一个包含有效数字的字符串时，先将变量转换为数字再操作
